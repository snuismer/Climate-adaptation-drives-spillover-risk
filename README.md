...
- [`Data`](/Data/) - Data on livestock herd composition, livestock seroprevalence, and the force of *Brucella* spillover into the human population for the 15 study villages in Marsabit and Kajiado counties, Kenya. This folder also contains results from simulated data and parameter estimates used to produce visual outputs. 
