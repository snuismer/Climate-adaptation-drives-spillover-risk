...
# write.csv(mle, file="MLE_Village_Level__gammahalf_omega5.csv")
# write.csv(mle, file="MLE_Village_Level__gammahalf_omega15.csv")
# write.csv(mle, file="MLE_Village_Level__gamma2_omega5.csv")
# write.csv(mle, file="MLE_Village_Level__gamma2_omega15.csv")
